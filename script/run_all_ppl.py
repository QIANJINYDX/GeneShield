...
GEN_DATASET_ROOT = os.path.join(PROJECT_ROOT, "data", "all_viral", "gen_data")
...
def run(
    ...
    if model_name == "evo-1-8k-base" or model_name == "evo-1-131k-base" or model_name == "evo-1.5-8k-base":
        ...
        MODEL_DIR = os.path.join(MODEL_WEIGHT, model_name)
        CFG_PATH = os.path.join(MODEL_WEIGHT, model_name, f"{model_name}_inference.yml")
        HF_HOME = os.path.join(MODEL_WEIGHT, "cache")
        ...
        MODEL_DIR = os.path.join(MODEL_WEIGHT, model_name, f"{model_name}.pt")
        ...
        if model_name == "hyenadna-tiny-16k":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "hyenadna-tiny-16k-seqlen-d128-hf")
        elif model_name == "hyenadna-tiny-1k":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "hyenadna-tiny-1k-seqlen-hf")
        elif model_name == "hyenadna-small-32k":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "hyenadna-small-32k-seqlen-hf")
        elif model_name == "hyenadna-medium-160k":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "hyenadna-medium-160k-seqlen-hf")
        elif model_name == "hyenadna-medium-450k":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "hyenadna-medium-450k-seqlen-hf")
        elif model_name == "hyenadna-large-1m":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "hyenadna-large-1m-seqlen-hf")
        ...
        if model_name == "Genos-1.2B":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "Genos-1.2B")
            default_hidden_size = 1024  # Genos-1.2B 的默认 hidden_size
            batch_size = 16
        elif model_name == "Genos-10B":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "Genos-10B")
            ...
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "Genos-10B-v2")
        ...
        if model_name == "GenomeOcean-100M":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GenomeOcean-100M")
        elif model_name == "GenomeOcean-500M":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GenomeOcean-500M")
        elif model_name == "GenomeOcean-4B":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GenomeOcean-4B")
        ...
        if model_name == "GENERator-v2-eukaryote-1.2b-base":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GENERator-v2-eukaryote-1.2b-base")
        elif model_name == "GENERator-v2-eukaryote-3b-base":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GENERator-v2-eukaryote-3b-base")
        elif model_name == "GENERator-v2-prokaryote-1.2b-base":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GENERator-v2-prokaryote-1.2b-base")
        elif model_name == "GENERator-v2-prokaryote-3b-base":
            MODEL_DIR = os.path.join(MODEL_WEIGHT, "GENERator-v2-prokaryote-3b-base")
        ...
        if model_name == "OmniReg-bigbird":
            MODEL_CKPT = os.path.join(MODEL_WEIGHT, "gena-lm-bigbird-base-t2t", "pytorch_model.bin")
            TOKENIZER_DIR = os.path.join(MODEL_WEIGHT, "omnireg_bigbird")
        elif model_name == "OmniReg-base":
            MODEL_CKPT = os.path.join(MODEL_WEIGHT, "gena-lm-bert-base-t2t", "pytorch_model.bin")
            TOKENIZER_DIR = os.path.join(MODEL_WEIGHT, "gena-lm-bert-base-t2t")
        elif model_name == "OmniReg-large":
            MODEL_CKPT = os.path.join(MODEL_WEIGHT, "gena-lm-bert-large-t2t", "pytorch_model.bin")
            TOKENIZER_DIR = os.path.join(MODEL_WEIGHT, "gena-lm-bert-large-t2t")
        TOKENIZER_DIR = os.path.join(MODEL_WEIGHT, "gena-lm-bert-large-t2t")
    ...
    if dataset_name == "genome-short":
        dataset = GenDataset(jsonl_path=os.path.join(GEN_DATASET_ROOT, "genome_gen", "short_sequences.jsonl"))
    elif dataset_name == "genome-medium":
        dataset = GenDataset(jsonl_path=os.path.join(GEN_DATASET_ROOT, "genome_gen", "medium_sequences.jsonl"))
    elif dataset_name == "genome-long":
        dataset = GenDataset(jsonl_path=os.path.join(GEN_DATASET_ROOT, "genome_gen", "long_sequences.jsonl"))
